...
#define UE_PROJECT_NAME LiquidX_Test
#define UE_TARGET_NAME LiquidX_TestEditor
#define UE_MODULE_NAME "LiquidX_Test"
...
#define LIQUIDX_TEST_API DLLEXPORT
